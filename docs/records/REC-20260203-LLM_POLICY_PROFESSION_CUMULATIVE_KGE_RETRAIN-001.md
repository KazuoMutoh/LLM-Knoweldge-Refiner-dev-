# REC-20260203-LLM_POLICY_PROFESSION_CUMULATIVE_KGE_RETRAIN-001: LLM-policy（profession）の累積追加トリプルでKGEを再学習し、同数Randomと比較する（実験計画）
...
**累積union**の評価設定で検証する（対象関係: `/people/person/profession`）。
...
- dataset_dir（head_incident_v1 + KG-FIT用テキスト付与済み）:
  - `/app/experiments/test_data_for_profession_head_incident_v1_kgfit`
- target_triples:
  - `/app/experiments/test_data_for_profession_head_incident_v1_kgfit/target_triples.txt`
- candidate_triples（local acquisition; train_removed からのみ追加）:
  - `/app/experiments/test_data_for_profession_head_incident_v1_kgfit/train_removed.txt`
...
- model_before_dir:
  - `/app/models/20260126_rerun1/fb15k237_kgfit_pairre_profession_head_incident_v1_before_ep100_lowmem_bs128`

### 2.3 rule_pool / arms（rerun1 profession の UCB run から流用）

- rule_pool_pkl:
  - `/app/experiments/20260126_rerun1/exp_ucb_arm10_priors_off_kgfit_pairre_ep100_profession_head_incident_v1_20260127b/rule_pool/initial_rule_pool.pkl`
- initial_arms.json:
  - `/app/experiments/20260126_rerun1/exp_ucb_arm10_priors_off_kgfit_pairre_ep100_profession_head_incident_v1_20260127b/arms/initial_arms.json`
...
- リーク防止:
  - after 学習に追加するトリプルから、target predicate `/people/person/profession` を除外する
- 評価指標:
...
出力先（新規）:
- `/app/experiments/20260203_llm_policy_profession_head_incident_v1_from_rerun1/`

smoke test（n_iter=1）:
- `python run_arm_refinement.py \
  --base_output_path /app/experiments/20260203_llm_policy_profession_head_incident_v1_from_rerun1/arm_run_smoke \
  --initial_arms /app/experiments/20260126_rerun1/exp_ucb_arm10_priors_off_kgfit_pairre_ep100_profession_head_incident_v1_20260127b/arms/initial_arms.json \
  --rule_pool_pkl /app/experiments/20260126_rerun1/exp_ucb_arm10_priors_off_kgfit_pairre_ep100_profession_head_incident_v1_20260127b/rule_pool/initial_rule_pool.pkl \
  --dir_triples /app/experiments/test_data_for_profession_head_incident_v1_kgfit \
...
本番（n_iter=25）:
- `python run_arm_refinement.py \
  --base_output_path /app/experiments/20260203_llm_policy_profession_head_incident_v1_from_rerun1/arm_run \
  --initial_arms /app/experiments/20260126_rerun1/exp_ucb_arm10_priors_off_kgfit_pairre_ep100_profession_head_incident_v1_20260127b/arms/initial_arms.json \
  --rule_pool_pkl /app/experiments/20260126_rerun1/exp_ucb_arm10_priors_off_kgfit_pairre_ep100_profession_head_incident_v1_20260127b/rule_pool/initial_rule_pool.pkl \
  --dir_triples /app/experiments/test_data_for_profession_head_incident_v1_kgfit \
  --target_triples /app/experiments/test_data_for_profession_head_incident_v1_kgfit/target_triples.txt \
...
重要:
- `/people/person/profession` を含むトリプルは **サンプル元から除外**する（除外は評価時にも行うが、件数整合のため事前除外を推奨）。
- 重複トリプルは除外（ユニーク化）。
...
- actual（iter1..3）:
  - `python retrain_and_evaluate_after_arm_run.py \
    --run_dir /app/experiments/20260203_llm_policy_profession_head_incident_v1_from_rerun1/arm_run_union_iter1_3 \
    --dataset_dir /app/experiments/test_data_for_profession_head_incident_v1_kgfit \
    --target_triples /app/experiments/test_data_for_profession_head_incident_v1_kgfit/target_triples.txt \
    --model_before_dir /app/models/20260126_rerun1/fb15k237_kgfit_pairre_profession_head_incident_v1_before_ep100_lowmem_bs128 \
    --after_mode retrain \
    --embedding_config /app/config_embeddings_kgfit_pairre_fb15k237_lowmem_bs128.json \
    --num_epochs 2 \
    --exclude_predicate /people/person/profession \
    --force_retrain`

- random（iter1..3, seed0）:
  - `python retrain_and_evaluate_after_arm_run.py \
    --run_dir /app/experiments/20260203_llm_policy_profession_head_incident_v1_from_rerun1/arm_run_random_union_iter1_3_seed0 \
    --dataset_dir /app/experiments/test_data_for_profession_head_incident_v1_kgfit \
    --target_triples /app/experiments/test_data_for_profession_head_incident_v1_kgfit/target_triples.txt \
    --model_before_dir /app/models/20260126_rerun1/fb15k237_kgfit_pairre_profession_head_incident_v1_before_ep100_lowmem_bs128 \
    --after_mode retrain \
